...
return `<div id="footer">
      <div id="foot1">
        <div id="fdiv1">
          <img
            width="133"
            height="82"
            src="https://www.thebowlcompany.in/wp-content/uploads/2021/09/The-Bowl-Company-Logo2.png"
            alt=""
            class="wp-image-24"
          />
        </div>
        <div id="fdiv2">
          ...
          <ul id="menu-footer-menu" class="menu">
            ...
            <li
              id="menu-item-4277"
              class="menu-item menu-item-type-custom menu-item-object-custom menu-item-4277"
            >
              <a
                target="_blank"
                rel="noopener"
        ...
        <div id="fdiv4">
          <h3>Subscribe</h3>
          <h4>Receive notifications of new offers by email</h4>
          <div>
            <input
              type="text"
              name="esfpx_name"
              class="ig_es_form_field_name"
      ...
      <div id="foot2">
        <div>
          <h3>Follow Us</h3>
          <a
            href="https://www.facebook.com/TheBowlCompanyIndia/"
            aria-label="Facebook"
            target="_blank"
            ...
            ><span class="ahfb-svg-iconset ast-inline-flex svg-baseline"
              ><svg class="footsvg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                <path
                  d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z"
                ></path></svg></span></a
          ><a
            href="https://www.instagram.com/thebowlcompanyindia/"
            ...
            ><span class="ahfb-svg-iconset ast-inline-flex svg-baseline"
              ><svg class="footsvg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                ...
                ></path></svg></span></a
          ><a
            href="https://twitter.com/tbc_india"
            aria-label="Twitter"
            target="_blank"
            rel="noopener noreferrer"
            ...
            ><span class="ahfb-svg-iconset ast-inline-flex svg-baseline"
              ><svg class="footsvg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path
      ...
      <div id="foot3">
        <p>
          <span style="font-size: 12pt">
            <strong>
              <span style="color: #7b7c7f">© ALL RIGHTS RESERVED</span>
            </strong>
          </span>
        </p>
      </div>
